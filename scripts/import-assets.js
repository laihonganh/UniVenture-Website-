...
async function main() {
  ...
  if (args[0] === 'mentors') {
    // pass mentor file paths after the 'mentors' arg
  ...
  console.log('Usage: node import-assets.js schools [sourceDir] [outDir]');
  console.log('   or: node import-assets.js mentors [outDir] <file1> <file2> ...');
}
